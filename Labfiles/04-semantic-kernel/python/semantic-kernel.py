...
async def main(): # loads a file containing expenses data, asks the user for instructions, and and then calls…
    # Clear the console
...
async def process_expenses_data(prompt, expenses_data):
    ...
    load_dotenv()
    ai_agent_settings = AzureAIAgentSettings() # will automatically include the Azure AI Agent settings from the configuration
